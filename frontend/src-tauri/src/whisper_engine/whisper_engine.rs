...
impl WhisperEngine {
        ...
        match model_info.status {
            ModelStatus::Available => {
                ...
                let ctx = {
                    ...
                    WhisperContext::new_with_params(model_info.path.as_path(), context_param)
    ...
    pub async fn transcribe_audio_with_confidence(&self, audio_data: Vec<f32>, language: Option<String>) -> Result<(String, f32, bool)> {
        ...
        params.set_suppress_nst(true); // whisper-rs 0.16: renamed from set_suppress_non_speech_tokens
        ...
        // whisper.cpp defaults to 4 threads; without this the adaptive
        // max_threads config was computed but never applied.
        ...
        for i in 0..num_segments {
            // whisper-rs 0.16: segment access is via get_segment(i) -> WhisperSegment.
