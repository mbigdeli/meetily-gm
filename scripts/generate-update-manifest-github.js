...
console.log(`GitHub Repository: mbigdeli/meetily-gm`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/mbigdeli/meetily-gm/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/mbigdeli/meetily-gm/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/mbigdeli/meetily-gm/releases/latest/download/latest.json`);
